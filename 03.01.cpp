...
double ComputeLight(const Point &P, const Point &N)
{
    double i = 0.0;
...
Color TraceRay(const Point &O, const Point &D, double t_min, double t_max)
{
    ...
    return scene.spheres[ind].color * ComputeLight(P, N);
}
...
int main()
{
    ...
    scene.spheres.push_back(Sphere{Point{0, -5001, 0}, 5000.0, Color{255, 255, 0}});
